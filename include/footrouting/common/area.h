...
#include "footrouting/common/geometry/polygon.h"
#include "footrouting/common/geometry/serializable_polygon.h"
#include "footrouting/common/matrix.h"
#include "footrouting/common/node.h"
...
struct area {
  ...
  std::vector<merc> get_ring_points(
      typename polygon_t::ring_type const& nodes) const {
...
BOOST_GEOMETRY_REGISTER_POINT_2D_GET_SET(
    footrouting::area::point, double,
    boost::geometry::cs::spherical_equatorial<boost::geometry::degree>,
    footrouting::area::point::lon, footrouting::area::point::lat,
    footrouting::area::point::set_lon, footrouting::area::point::set_lat)
