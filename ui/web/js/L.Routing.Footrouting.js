L.Routing.FootRouting = L.Class.extend({
    ...
    route: function (waypoints, callback, context, options) {
        ...
        request = this.buildRouteRequest(waypoints, options, self.options.searchProfile);
...
L.Routing.footRouting = function (options) {
    return new L.Routing.FootRouting(options);
};
